                ...
                <v-flex
                  ...
                  <v-flex
                    ...
                    <v-text-field
                        ...
                        :label=" tryT('militantAdmissionDate') "></v-text-field>
                  </v-flex>
                  <v-flex
                      xs12
                      md12
                    ...
                    <v-text-field
                        ...
                        :label=" tryT('militantFormalizationDate') "></v-text-field>
                  </v-flex>
                  <v-flex
                      xs12
                      md12
                  ...
                  <v-flex
                    ...
                    <v-text-field
                        ...
                        :label=" tryT('registerDate') "></v-text-field>
                  </v-flex>
                  <v-flex
                      xs12
                      md12
                    ...
                    <v-text-field
                        ...
                        :label=" tryT('transferDate') "></v-text-field>
                  </v-flex>
