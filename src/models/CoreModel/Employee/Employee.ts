...
export default class Employee extends BaseModel {
  ...
  static fields () {
    return {
      ...
      birthday: this.string('birthday'),
      joiningDate: this.string('joiningDate'),
      emergencyContact: this.string('emergencyContact'),
      emergencyPhoneNo: this.string('emergencyPhoneNo'),
      contractStartDate: this.string('contractStartDate'),
      contractEndDate: this.string('contractEndDate'),
      ...
      dateOfIssue: this.string('dateOfIssue'),
